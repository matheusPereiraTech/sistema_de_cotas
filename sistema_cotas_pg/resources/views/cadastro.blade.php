                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="data_nascimento"
                                            id="data_nascimento" placeholder="Data de nascimento"><br><br>
                                        ...
                                        <input type="text" class="form-control" name="forma_ingresso"
                                            id="forma_ingresso" placeholder="Forma de ingresso"><br><br>
